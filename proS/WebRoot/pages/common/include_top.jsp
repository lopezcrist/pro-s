...
<div id="mainbox">
<div id="menu">
	<div class="menu_item"><s:a action="targetAction" method="findTargets" namespace="/pages/target">目标</s:a></div>
	<div class="menu_item"><s:a action="targetAction" method="toTargetAddPage" namespace="/pages/target">增加目标</s:a></div>
	<div class="menu_item"><s:a action="targetCatelogAction" method="findTargetCatelogs" namespace="/pages/target_catelog">目标分类</s:a></div>
